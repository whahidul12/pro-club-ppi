  ...
  return (
    <section className="bg-gray-50 py-10 sm:pt-16 lg:pt-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-x-12 gap-y-16 md:col-span-3">
          <div className="col-span-2 md:col-span-3">
            ...
            <p>
              ...
              accusamus voluptas fuga nemo quis! Vel veniam nisi nostrum enim
              doloremque odio sapiente voluptatibus quidem ex ratione dolorem
              recusandae labore mollitia similique incidunt dicta nemo ab, id
              autem vitae dolorum doloribus inventore rem. Eos nihil
              necessitatibus sit incidunt, eum a veritatis.
            </p>
          ...
          <div className="col-span-2 md:col-span-1">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d924.1368859441286!2d89.24167312416232!3d24.01872606145727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fe9b369a35dcfb%3A0x3c8cff0140e21bb8!2sPabna%20Polytechnic%20Institute!5e1!3m2!1sen!2sbd!4v1761675650584!5m2!1sen!2sbd"
              // width="600"
              // height="450"
              style={{}}
